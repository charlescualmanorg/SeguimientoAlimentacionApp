            ...
            <div class="card mb-4 position-relative">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('posts.like', $post->id) }}" method="POST">
                        @csrf
                        <!-- Comprobamos si el post tiene likes -->
                        @if(Auth::check())
                            <!-- Comprobamos si el post tiene likes solo si el usuario está autenticado -->
                        ...
                        @else
                            <!-- Mostrar sólo el contador de likes si no está autenticado -->
                    ...
                    <div class="comments-container">
                        ...
                        <div class="mb-2">
                            ...
                            @if(Auth::user()->id === $comment->user_id || Auth::user()->id === $post->user_id)
                                <form action="{{ route('comments.destroy', $comment->id) }}" method="POST"  class="position-absolute" style="right: 1px;">
                                    @csrf
                                    @method('DELETE')
